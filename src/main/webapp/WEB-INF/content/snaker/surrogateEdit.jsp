...
<html lang="en">
	...
	<body>
		<form id="inputForm" action="${ctx }/snaker/surrogate/update" method="post">
			<input type="hidden" name="surrogate.id" id="id" value="${surrogate.id }"/>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0" style="margin-top: 0px">
				...
				<tr>
					...
					<td class="td_table_2">
						<input type="text" class="input_240" id="sdate" name="surrogate.sdate"
					...
					<td class="td_table_2">
						<input type="text" class="input_240" id="edate" name="surrogate.edate"
