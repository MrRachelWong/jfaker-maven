...
<html>
	...
	<form id="mainForm" action="${ctx}/snaker/task/active" method="get">
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					待办任务<font color="red">[共:${majorTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task/activeMore?taskType=0">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					协办任务<font color="red">[共:${aidantTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task/activeMore?taskType=1">更多...</a></font>
				</td>
			</tr>
		</table>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				<td class="td_table_top" align="left">
					抄送任务<font color="red">[共:${ccorderTotal }项]&nbsp;&nbsp;<a href="${ctx}/snaker/task/activeCCMore">更多...</a></font>
				</td>
			</tr>
		</table>
			...
			<c:forEach items="${ccorderWorks}" var="item">
				<tr>
					...
					<td class="td_list_2" align=left nowrap>
						...
						<a href="${ctx}/snaker/flow/ccread?id=${item.id}&url=/snaker/task/active " class="btnRead" title="关闭">关闭</a>
					</td>
				</tr>
			</c:forEach>
