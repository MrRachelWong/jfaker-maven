		...
		<form id="inputForm" action="${ctx }/config/form/update" method="post">
			...
			<table class="table_all" align="center" border="0" cellpadding="0"
				...
				<tr>
					...
					<td class="td_table_2">
						<frame:select name="form.type" type="select" configName="formType" cssClass="input_select" value="${form.type }"/>
					</td>
				</tr>
				<tr>
					<td class="td_table_1">
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="displayName" name="form.displayName" value="${form.displayName }"/>
					</td>
				</tr>
			</table>
