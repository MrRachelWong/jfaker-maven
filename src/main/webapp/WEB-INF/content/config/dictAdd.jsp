			...
			<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px">
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="name" name="dict.name" />
					</td>
				</tr>
				<tr>
					<td class="td_table_1">
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="cnName" name="dict.cnName" />
					</td>
				</tr>
				<tr>
					<td class="td_table_1">
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="description" name="dict.description"  />
					</td>
				</tr>
			</table>
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" id="itemTable" style="margin: 0">
							...
							<c:forEach var="item" items="${dict.items}" varStatus="s">
								<tr>
									<td class="td_list_2">
