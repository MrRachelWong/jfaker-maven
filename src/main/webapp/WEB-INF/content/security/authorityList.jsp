...
<html>
	...
	<form id="mainForm" action="${ctx}/security/authority?lookup=${lookup }" method="get">
		...
		<table align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<c:choose>
					...
					<input type='button' onclick="addNew('${ctx}/security/authority/add')" class='button_70px' value='新建'/>
					</shiro:hasPermission>
					</c:when>
					<c:otherwise>
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			...
			<c:forEach items="${page.list}" var="authority">
				<tr>
					...
					<shiro:hasPermission name="AUTHORITYEDIT">
						<a href="${ctx}/security/authority/edit/${authority.id }" class="btnEdit" title="编辑">编辑</a>
					</shiro:hasPermission>
