...
<html lang="en">
	...
	<body>
		<form id="inputForm" action="${ctx }/security/menu/save" method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0" style="margin-top: 0px">
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="hidden" id="parentMenuId" name="menu.parent_menu">
						<input type="text" id="parentMenuName" readonly="readonly" name="parentMenuName" class="input_240">
