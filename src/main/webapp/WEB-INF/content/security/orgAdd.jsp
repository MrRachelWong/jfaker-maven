...
<html lang="en">
	...
	<body>
		<form id="inputForm" action="${ctx }/security/org/save" method="post">
		...
		<table class="table_all" align="center" border="0" cellpadding="0"
			cellspacing="0" style="margin-top: 0px">
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="name" name="org.name"
							value="${org.name }" />
					</td>
				</tr>
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="hidden" id="parentOrgId" name="org.parent_org">
						<input type="text" id="parentOrgName" readonly="readonly" name="parentOrgName" class="input_240">
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_520" id="description" name="org.description"
