	...
	<body>
		<form id="inputForm" action="${ctx }/snaker/flow/process" method="post" target="mainFrame">
			...
			cellspacing="0" style="margin-top: 0px">
				<tr>
					<td class="td_table_1"><span>申请push人：</span></td>
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" readonly="readonly" name="S_push_notest_apply.operator" value="${operator  }" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="td_table_1"><span>push内容：</span></td>
					<td class="td_table_2" colspan="3">
						<textarea class="input_textarea_320" id="file" name="S_file"></textarea>
					</td>
				</tr>
				<tr>
					<td class="td_table_1"><span>免测push审批人：</span></td>
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" name="S_push_notest_approve.operator" value="${operator }" />
					</td>
				</tr>
				<tr>
					<td class="td_table_1"><span>diff确认：</span></td>
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" name="S_push_notest_diff_approve.operator" value="${operator }" />
					</td>
				</tr>
				<tr>
