			...
			cellspacing="0" style="margin-top: 0px">
				...
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="amount" name="borrow.amount" value="${borrow.amount }" />元
					</td>
				</tr>
				<tr>
					<td class="td_table_1"><span>借款理由：</span></td>
					<td class="td_table_2" colspan="3">
						<textarea class="input_textarea_320" id="description" name="borrow.description">${borrow.description }</textarea>
					</td>
				</tr>
			</table>
